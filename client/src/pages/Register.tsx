    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: '#ffffff' }}>
      <div className="w-full max-w-sm page-transition">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold animate-slide-up" style={{ color: '#111827' }}>Create your account</h1>
          <p className="mt-1.5 text-sm animate-slide-up" style={{ color: '#6b7280', animationDelay: '0.05s' }}>Get started with ScriptGPT</p>
        </div>
